...
# ------------------ Projects ------------------ 
Project.create(title: "Social Media", image_url: "", information: "REMOTE: Peace Coffee would love help for setting up a Facebook page to showcase online menu and pickup/delivery options.", user_id: peace_coffee.id)
Project.create(title: "Online Order", image_url: "", information: "REMOTE: Rabbit Hole would appreciate help for setting up online order and delivery on the website.", user_id: rabbit_hole.id)
Project.create(title: "Book Organizer", image_url: "", information: "IN-PERSON: Wild Rumpus is looking for 2 volunteers to help organizing books and managing new pickup option.", user_id: wild_rumpus.id)
Project.create(title: "Food Bank", image_url: "", information: "IN-PERSON: Neighborhood House needs 15 volunteers to help food distribution.", user_id: neighborhood_house.id)
Project.create(title: "Produce Giveaway", image_url: "", information: "IN-PERSON: Friends In Need is looking for help to collect and giveaway produce.", user_id: fin.id)
Project.create(title: "Inventory Management", image_url: "", information: "REMOTE: The Salvation Army Saint Paul is seeking a volunteer to help set up inventory management online.", user_id: salvation_army.id)